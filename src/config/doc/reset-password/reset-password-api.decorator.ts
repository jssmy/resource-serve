...
export function ApiSendResetPasswordMail() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Solicita un reset de contraseña enviando un email con un token al usuario',
    }),
    ApiBody({
      type: 'object',
    ...
    ApiSuccessResponse('Solicitud de reset enviada exitosamente', {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example:
            'Mail reset password was send to user@example.com, please check your inbox',
        },
      },
    }),
    ApiResponse({
...
export function ApiResetPassword() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Cambia la contraseña del usuario usando el token válido enviado por email',
    }),
    ApiParam({
      name: 'token',
